...
class Reader
  ...
  def read_xf work, pos, len
    ...
    fmt.right          = XF_BORDER_LINE_STYLES[xf_borders & 0x000000f0]
    fmt.top    				 = XF_BORDER_LINE_STYLES[xf_borders & 0x00000f00]
    fmt.bottom         = XF_BORDER_LINE_STYLES[xf_borders & 0x0000f000]
    fmt.left_color     = COLOR_CODES[xf_borders & 0x007f0000] || :builtin_black
    fmt.right_color    = COLOR_CODES[xf_borders & 0x3f800000] || :builtin_black
    fmt.cross_down     = xf_borders & 0x40000000 > 0
    fmt.cross_up       = xf_borders & 0x80000000 > 0
    fmt.top_color      = COLOR_CODES[xf_brdcolors & 0x0000007f] || :builtin_black
    fmt.bottom_color   = COLOR_CODES[xf_brdcolors & 0x00003f80] || :builtin_black
    fmt.diagonal_color = COLOR_CODES[xf_brdcolors & 0x001fc000] || :builtin_black
